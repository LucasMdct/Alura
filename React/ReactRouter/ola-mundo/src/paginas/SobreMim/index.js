...
export default function SobreMim() {
    return (
        ...
        >
            ...
            <p className={styles.paragrafo}>
                E foi enquanto eu estava no BOOTCAMP DB1 que decidi procurar o mais rápido possível entrar no mercado de trabalho. Eu encontrei uma vaga na DB1 Global Software como Dev Trainee e percebi que ela foi uma grande oportunidade, para iniciar a carreira de programação que é a verdadeira paixão minha. Para minha felicidade, participei de um processo seletivo, com a recrutadora Bianca, também com o gestor Cleber e fui escolhido para fazer parte do time de desenvolvimento da UNIPRIME.

            </p>
            <p className={styles.paragrafo}>
                Desde então, tem sido aprenas aprendizados atrás de aprendizados. fico bastante grato aos professores do curso prático, o BOOTCAMP DB1, em específico a um professor único, tech lead e padrinho na DB1 ( DOUGLAS JUNIOR ) onde sempre apoiou os alunos :
            </p>

            <p className={styles.paragrafo}>
                <strong> "SE TEM UMA PEQUENA CHANCE DE GOSTAR DISSO, ABRAÇA ISSO COM TODAS AS SUAS FORÇAS."</strong>
            </p>
            <p className={styles.paragrafo}>
